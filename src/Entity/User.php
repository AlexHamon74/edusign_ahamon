...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: UserLesson::class, mappedBy: 'user', cascade: ['remove'], orphanRemoval: true)]
